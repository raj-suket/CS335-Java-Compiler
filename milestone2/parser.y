...
IntegralType:
	INTEGRALTYPE 										{cout << "CHECKo\n" ; vec = {createnode("INTEGRALTYPE__" + *$1 , emp)}; $$ = createnode("IntegralType", vec);}
	;
...
CompilationUnit:
	OrdinaryCompilationUnit 										{cout << "checkt\n"; vec = {$1}; root = createnode("CompilationUnit", vec);}
...
ClassDeclaration:
	Modifiers CLASS {to_declare = 1;} Identifier {to_declare = 0;} ClassExtends {incr_scope();} ClassBody 										{hide_scope(); vec = {$1,createnode("CLASS__" + *$2 , emp),$4,$6,$8}; $$ = createnode("ClassDeclaration", vec);}
|	CLASS {to_declare = 1;} Identifier {to_declare = 0;} ClassExtends {incr_scope();} ClassBody 										{hide_scope(); vec = {createnode("CLASS__" + *$1 , emp),$3,$5,$7}; $$ = createnode("ClassDeclaration", vec);}
|	Modifiers CLASS {to_declare = 1;} Identifier {to_declare = 0;incr_scope();} ClassBody 										{hide_scope(); vec = {$1,createnode("CLASS__" + *$2 , emp),$4,$6}; $$ = createnode("ClassDeclaration", vec);}
|	CLASS {to_declare = 1;} Identifier {to_declare = 0;incr_scope();} ClassBody 										{hide_scope(); vec = {createnode("CLASS__" + *$1 , emp),$3,$5}; $$ = createnode("ClassDeclaration", vec);}
	;
...
FieldDeclaration:
	Modifiers Type {to_declare=1;} VariableDeclaratorList {to_declare=0;} SEMICOLON 										{vec = {$1,$2,$4,createnode("SEMICOLON__" + *$6, emp)}; $$ = createnode("FieldDeclaration", vec);}
|	Type {to_declare=1;} VariableDeclaratorList {to_declare=0;} SEMICOLON 										{vec = {$1,$3,createnode("SEMICOLON__" + *$5 , emp)}; $$ = createnode("FieldDeclaration", vec);}
	;
...
|	VariableDeclaratorId {to_declare = 0;} EQUALTO VariableInitializer 										{ to_declare = 1; vec = {$1,createnode("EQUALTO__" + *$3 , emp),$4}; $$ = createnode("VariableDeclarator", vec);}
	;
...
MethodDeclaration:
	MethodHeader MethodBody 										{hide_scope(); vec = {$1,$2}; $$ = createnode("MethodDeclaration", vec);}
	;

MethodHeader:
	Modifiers Type {to_declare = 1;} MethodDeclarator {to_declare = 0;} Throws 										{vec = {$1,$2,$4,$6}; $$ = createnode("MethodHeader", vec);}
|	Type {to_declare = 1;} MethodDeclarator {to_declare = 0;} Throws 										{vec = {$1,$3,$5}; $$ = createnode("MethodHeader", vec);}
|	Modifiers Type {to_declare = 1;} MethodDeclarator {to_declare = 0;} 										{vec = {$1,$2,$4}; $$ = createnode("MethodHeader", vec);}
|	Type {to_declare = 1;} MethodDeclarator {to_declare = 0;} 										{vec = {$1,$3}; $$ = createnode("MethodHeader", vec);}
|	Modifiers VOID {to_declare = 1;} MethodDeclarator {to_declare = 0;} Throws 										{vec = {$1,createnode("VOID__" + *$2 , emp),$4,$6}; $$ = createnode("MethodHeader", vec);}
|	VOID {to_declare = 1;} MethodDeclarator {to_declare = 0;} Throws 										{vec = {createnode("VOID__" + *$1 , emp),$3,$5}; $$ = createnode("MethodHeader", vec);}
|	Modifiers VOID {to_declare = 1;} MethodDeclarator {to_declare = 0;} 										{vec = {$1,createnode("VOID__" + *$2 , emp),$4}; $$ = createnode("MethodHeader", vec);}
|	VOID {to_declare = 1;} MethodDeclarator {to_declare = 0;} 										{vec = {createnode("VOID__" + *$1 , emp),$3}; $$ = createnode("MethodHeader", vec);}
	;

MethodDeclarator:
	Identifier {incr_scope();} LRB FormalParameterList RRB 										{vec = {$1,createnode("LRB__" + *$3 , emp),$4,createnode("RRB__" + *$5 , emp)}; $$ = createnode("MethodDeclarator", vec);}
|	Identifier {incr_scope();} LRB RRB 										{vec = {$1,createnode("LRB__" + *$3 , emp),createnode("RRB__" + *$4 , emp)}; $$ = createnode("MethodDeclarator", vec);}
...
FormalParameter:
	Type {to_declare=1;} VariableDeclaratorId 										{to_declare=0; vec = {$1,$3}; $$ = createnode("FormalParameter", vec);}
|	Modifiers Type {to_declare=1;} VariableDeclaratorId 										{to_declare=0; vec = {$1,$2,$4}; $$ = createnode("FormalParameter", vec);}
	;
...
InstanceInitializer:
	{incr_scope();} Block 										{hide_scope(); vec = {$2}; $$ = createnode("InstanceInitializer", vec);}
	;

StaticInitializer:
	STATIC {incr_scope();} Block 										{hide_scope(); vec = {createnode("STATIC__" + *$1 , emp),$3}; $$ = createnode("StaticInitializer", vec);}
	;

ConstructorDeclaration:
	Modifiers {to_declare=1;} ConstructorDeclarator {to_declare=0;} Throws ConstructorBody 										{hide_scope(); vec = {$1,$3,$5,$6}; $$ = createnode("ConstructorDeclaration", vec);}
|	{to_declare=1;} ConstructorDeclarator {to_declare=0;} Throws ConstructorBody 										{hide_scope(); vec = {$2,$4,$5}; $$ = createnode("ConstructorDeclaration", vec);}
|	Modifiers {to_declare=1;} ConstructorDeclarator {to_declare=0;} ConstructorBody 										{hide_scope(); vec = {$1,$3,$5}; $$ = createnode("ConstructorDeclaration", vec);}
|	{to_declare=1;} ConstructorDeclarator {to_declare=0;} ConstructorBody 										{hide_scope(); vec = {$2,$4}; $$ = createnode("ConstructorDeclaration", vec);}
	;

ConstructorDeclarator:
	Identifier {incr_scope();} LRB FormalParameterList RRB 										{vec = {$1,createnode("LRB__" + *$3 , emp),$4,createnode("RRB__" + *$5 , emp)}; $$ = createnode("ConstructorDeclarator", vec);}
|	Identifier {incr_scope();} LRB RRB 										{vec = {$1,createnode("LRB__" + *$3 , emp),createnode("RRB__" + *$4 , emp)}; $$ = createnode("ConstructorDeclarator", vec);}
	;
...
LocalVariableDeclaration:
	Type {to_declare=1;} VariableDeclaratorList 										{to_declare=0; vec = {$1,$3}; $$ = createnode("LocalVariableDeclaration", vec);}
|	VAR {to_declare=1;} VariableDeclaratorList 										{to_declare=0; vec = {createnode("VAR__" + *$1 , emp),$3}; $$ = createnode("LocalVariableDeclaration", vec);}
|	Modifiers Type {to_declare=1;} VariableDeclaratorList 										{to_declare=0; vec = {$1,$2,$4}; $$ = createnode("LocalVariableDeclaration", vec);}
|	Modifiers VAR {to_declare=1;} VariableDeclaratorList 										{to_declare=0; vec = {$1,createnode("VAR__" + *$2 , emp),$4}; $$ = createnode("LocalVariableDeclaration", vec);}
	;
...
StatementWithoutTrailingSubstatement:
	{incr_scope();} Block 										{hide_scope(); vec = {$2}; $$ = createnode("StatementWithoutTrailingSubstatement", vec);}
...
BasicForStatement:
	FOR {incr_scope();} LRB ForInit SEMICOLON Expression SEMICOLON ForUpdate RRB {hide_scope();} Statement 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),$4,createnode("SEMICOLON__" + *$5 , emp),$6,createnode("SEMICOLON__" + *$7 , emp),$8,createnode("RRB__" + *$9 , emp),$11}; $$ = createnode("BasicForStatement", vec);}
|	FOR {incr_scope();} LRB SEMICOLON Expression SEMICOLON ForUpdate RRB {hide_scope();} Statement 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),createnode("SEMICOLON__" + *$4 , emp),$5,createnode("SEMICOLON__" + *$6 , emp),$7,createnode("RRB__" + *$8 , emp),$10}; $$ = createnode("BasicForStatement", vec);}
|	FOR {incr_scope();} LRB ForInit SEMICOLON SEMICOLON ForUpdate RRB {hide_scope();} Statement 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),$4,createnode("SEMICOLON__" + *$5 , emp),createnode("SEMICOLON__" + *$6 , emp),$7,createnode("RRB__" + *$8 , emp),$10}; $$ = createnode("BasicForStatement", vec);}
|	FOR {incr_scope();} LRB SEMICOLON SEMICOLON ForUpdate RRB {hide_scope();} Statement 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),createnode("SEMICOLON__" + *$4 , emp),createnode("SEMICOLON__" + *$5 , emp),$6,createnode("RRB__" + *$7 , emp),$9}; $$ = createnode("BasicForStatement", vec);}
|	FOR {incr_scope();} LRB ForInit SEMICOLON Expression SEMICOLON RRB {hide_scope();} Statement 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),$4,createnode("SEMICOLON__" + *$5 , emp),$6,createnode("SEMICOLON__" + *$7 , emp),createnode("RRB__" + *$8 , emp),$10}; $$ = createnode("BasicForStatement", vec);}
|	FOR {incr_scope();} LRB SEMICOLON Expression SEMICOLON RRB {hide_scope();} Statement 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),createnode("SEMICOLON__" + *$4 , emp),$5,createnode("SEMICOLON__" + *$6 , emp),createnode("RRB__" + *$7 , emp),$9}; $$ = createnode("BasicForStatement", vec);}
|	FOR {incr_scope();} LRB ForInit SEMICOLON SEMICOLON RRB {hide_scope();} Statement 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),$4,createnode("SEMICOLON__" + *$5 , emp),createnode("SEMICOLON__" + *$6 , emp),createnode("RRB__" + *$7 , emp),$9}; $$ = createnode("BasicForStatement", vec);}
|	FOR {incr_scope();} LRB SEMICOLON SEMICOLON RRB {hide_scope();} Statement 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),createnode("SEMICOLON__" + *$4 , emp),createnode("SEMICOLON__" + *$5 , emp),createnode("RRB__" + *$6 , emp),$8}; $$ = createnode("BasicForStatement", vec);}
	;

BasicForStatementNoShortIf:
	FOR {incr_scope();} LRB ForInit SEMICOLON Expression SEMICOLON ForUpdate RRB {hide_scope();} StatementNoShortIf 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),$4,createnode("SEMICOLON__" + *$5 , emp),$6,createnode("SEMICOLON__" + *$7 , emp),$8,createnode("RRB__" + *$9 , emp),$11}; $$ = createnode("BasicForStatementNoShortIf", vec);}
|	FOR {incr_scope();} LRB SEMICOLON Expression SEMICOLON ForUpdate RRB {hide_scope();} StatementNoShortIf 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),createnode("SEMICOLON__" + *$4 , emp),$5,createnode("SEMICOLON__" + *$6 , emp),$7,createnode("RRB__" + *$8 , emp),$10}; $$ = createnode("BasicForStatementNoShortIf", vec);}
|	FOR {incr_scope();} LRB ForInit SEMICOLON SEMICOLON ForUpdate RRB {hide_scope();} StatementNoShortIf 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),$4,createnode("SEMICOLON__" + *$5 , emp),createnode("SEMICOLON__" + *$6 , emp),$7,createnode("RRB__" + *$8 , emp),$10}; $$ = createnode("BasicForStatementNoShortIf", vec);}
|	FOR {incr_scope();} LRB SEMICOLON SEMICOLON ForUpdate RRB {hide_scope();} StatementNoShortIf 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),createnode("SEMICOLON__" + *$4 , emp),createnode("SEMICOLON__" + *$5 , emp),$6,createnode("RRB__" + *$7 , emp),$9}; $$ = createnode("BasicForStatementNoShortIf", vec);}
|	FOR {incr_scope();} LRB ForInit SEMICOLON Expression SEMICOLON RRB {hide_scope();} StatementNoShortIf 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),$4,createnode("SEMICOLON__" + *$5 , emp),$6,createnode("SEMICOLON__" + *$7 , emp),createnode("RRB__" + *$8 , emp),$10}; $$ = createnode("BasicForStatementNoShortIf", vec);}
|	FOR {incr_scope();} LRB SEMICOLON Expression SEMICOLON RRB {hide_scope();} StatementNoShortIf 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),createnode("SEMICOLON__" + *$4 , emp),$5,createnode("SEMICOLON__" + *$6 , emp),createnode("RRB__" + *$7 , emp),$9}; $$ = createnode("BasicForStatementNoShortIf", vec);}
|	FOR {incr_scope();} LRB ForInit SEMICOLON SEMICOLON RRB {hide_scope();} StatementNoShortIf 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),$4,createnode("SEMICOLON__" + *$5 , emp),createnode("SEMICOLON__" + *$6 , emp),createnode("RRB__" + *$7 , emp),$9}; $$ = createnode("BasicForStatementNoShortIf", vec);}
|	FOR {incr_scope();} LRB SEMICOLON SEMICOLON RRB {hide_scope();} StatementNoShortIf 										{vec = {createnode("FOR__" + *$1 , emp),createnode("LRB__" + *$3 , emp),createnode("SEMICOLON__" + *$4 , emp),createnode("SEMICOLON__" + *$5 , emp),createnode("RRB__" + *$6 , emp),$8}; $$ = createnode("BasicForStatementNoShortIf", vec);}
	;
