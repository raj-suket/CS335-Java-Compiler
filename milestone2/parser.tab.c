...
{
       0,   295,   295,   297,   297,   297,   297,   298,   298,   298,
     301
};
#endif
...
{
     -33,   -33,    -8,   -33,   -33,   -33,   -33,   -33,    -6
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,     6,    10,    14,     7,    11,     4
};
...
{
       0,    34,    94,    95,   101,     0,    96,    99,   101,   101,
      97,   100,   101,   101,    98,    95
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_int8 yyr1[] =
{
       0,    93,    94,    96,    97,    98,    95,    99,   100,    95,
     101
};
...
yyreduce:
  ...
  case 2:
#line 295 "parser.y"
                                                                                                {vec = {(yyvsp[0].str_val)}; root = createnode("try1", vec);}
...
#line 1490 "parser.tab.c"
  ...
  case 6:
#line 297 "parser.y"
                                                                                                                {hide_scope(); vec = {(yyvsp[-6].str_val), (yyvsp[-4].str_val), (yyvsp[-2].str_val), (yyvsp[0].str_val)}; (yyval.str_val) = createnode("try2", vec);}
...
#line 1508 "parser.tab.c"
  ...
  case 9:
#line 298 "parser.y"
                                                                                                {cout << "HIIITHISTHI\n\n";cout << ((yyvsp[-4].str_val))->val << "HUEHUE\n";vec = {(yyvsp[-4].str_val), (yyvsp[-2].str_val), (yyvsp[0].str_val)};  (yyval.str_val) = createnode("try2", vec);}
...
#line 301 "parser.y"
                                                                                                {
		cout << "HIInIdentifer\n";
		cout << (*(yyvsp[0].lex)) << " this is identifier val\n";
		// tab_item* t = lookup((*$1));
		if(to_declare){
