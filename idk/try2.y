...
|	MODULE Name LCB RCB 										{vec = {createnode("MODULE", empty),$2,createnode("LCB", empty),createnode("RCB", empty)}; $$ = createnode("ModuleDeclaration", vec);}
	;
...
|	REQUIRES Name SEMICOLON 										{vec = {createnode("REQUIRES", empty),$2,createnode("SEMICOLON", empty)}; $$ = createnode("ModuleDirective", vec);}
...
ClassDeclaration:
	Modifiers CLASS Identifier ClassExtends ClassBody 										{vec = {$1,createnode("CLASS", empty),$3,$4,$5}; $$ = createnode("ClassDeclaration", vec);}
|	CLASS Identifier ClassExtends ClassBody 										{vec = {createnode("CLASS", empty),$2,$3,$4}; $$ = createnode("ClassDeclaration", vec);}
...
ClassExtends:
	EXTENDS ClassType 										{vec = {createnode("EXTENDS", empty),$2}; $$ = createnode("ClassExtends", vec);}
	;

ClassBody:
	LCB RCB 										{vec = {createnode("LCB", empty),createnode("RCB", empty)}; $$ = createnode("ClassBody", vec);}
|	LCB ClassBodyDeclarations RCB 										{vec = {createnode("LCB", empty),$2,createnode("RCB", empty)}; $$ = createnode("ClassBody", vec);}
	;
...
|	SEMICOLON 										{vec = {createnode("SEMICOLON", empty)}; $$ = createnode("ClassMemberDeclaration", vec);}
	;

FieldDeclaration:
	Modifiers Type VariableDeclaratorList SEMICOLON 										{vec = {$1,$2,$3,createnode("SEMICOLON", empty)}; $$ = createnode("FieldDeclaration", vec);}
|	Type VariableDeclaratorList SEMICOLON 										{vec = {$1,$2,createnode("SEMICOLON", empty)}; $$ = createnode("FieldDeclaration", vec);}
	;

VariableDeclaratorList:
	VariableDeclarator 										{vec = {$1}; $$ = createnode("VariableDeclaratorList", vec);}
|	VariableDeclaratorList COMMA VariableDeclarator 										{vec = {$1,createnode("COMMA", empty),$3}; $$ = createnode("VariableDeclaratorList", vec);}
	;
...
|	VAR VariableDeclaratorList 										{vec = {createnode("VAR", empty),$2}; $$ = createnode("LocalVariableDeclaration", vec);}
|	Modifiers Type VariableDeclaratorList 										{vec = {$1,$2,$3}; $$ = createnode("LocalVariableDeclaration", vec);}
|	Modifiers VAR VariableDeclaratorList 										{vec = {$1,createnode("VAR", empty),$3}; $$ = createnode("LocalVariableDeclaration", vec);}
	;
...
|	CATCH LRB Modifiers CatchType VariableDeclaratorId RRB Block 										{vec = {createnode("CATCH", empty),createnode("LRB", empty),$3,$4,$5,createnode("RRB", empty),$7}; $$ = createnode("CatchClause", vec);}
	;
...
|	NEW ClassOrInterfaceType LRB RRB ClassBody 										{vec = {createnode("NEW", empty),$2,createnode("LRB", empty),createnode("RRB", empty),$5}; $$ = createnode("UnqualifiedClassInstanceCreationExpression", vec);}
|	NEW ClassOrInterfaceType LRB ArgumentList RRB ClassBody 										{vec = {createnode("NEW", empty),$2,createnode("LRB", empty),$4,createnode("RRB", empty),$6}; $$ = createnode("UnqualifiedClassInstanceCreationExpression", vec);}
...
|	SUPER DOT Identifier LRB ArgumentList RRB 										{vec = {createnode("SUPER", empty),createnode("DOT", empty),$3,createnode("LRB", empty),$5,createnode("RRB", empty)}; $$ = createnode("MethodInvocation", vec);}
...
PostDecrementExpression:
	PostfixExpression DECREMENT 										{vec = {$1,createnode("DECREMENT", empty)}; $$ = createnode("PostDecrementExpression", vec);}
	;
